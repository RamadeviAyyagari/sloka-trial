...
class Database extends \PDO
{
    ...
    public static function get($group = null)
    {
        ...
        $group = $group === null ? [
            'type'     => Box::$env['database']['type'],
            'hostname' => Box::$env['database']['hostname'],
            'database' => Box::$env['database']['database'],
            'username' => Box::$env['database']['username'],
            'password' => Box::$env['database']['password'],
        ] : $group;
