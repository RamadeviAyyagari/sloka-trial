...
class Html
{
    ...
    public static function bootstrapUIError($error, $showIcon = false, $dismissable = false)
    {
        $icon = '';
        if ($showIcon) {
    ...
    public static function bootstrapUIMessage($message, $showIcon = false, $dismissable = false)
    {
        $icon = '';
        if ($showIcon) {
